...
themes = {
	settings = {keyCode = "T", themeAmount = 17},
	theme1 = {
		index = 1,
		music = "ambient_theme1",
		texture = "THEME_GROUND_TEXTURE_1",
	...
	theme2 = {
		...
		texture = "THEME_GROUND_TEXTURE_2",
		graphicSetName = "THEME_02",
		
		-- SHEET, SPRITE, PARALLAX_SPEED, SCALE, LOOPING, POSITION (for non looping elements)
		bgLayers = { { "INGAME_SKIES_1", "BACKGROUND_2_LAYER_1", 0.125, 2.0 },
					 { "", "BACKGROUND_2_LAYER_2", 0.5, 2.0 },
					 { "", "BACKGROUND_2_LAYER_3", 1.0, 1.5 } },
	...
	theme3 = {
		...
		texture = "THEME_GROUND_TEXTURE_3",
		graphicSetName = "THEME_03",
		
		-- SHEET, SPRITE, PARALLAX_SPEED, SCALE, LOOPING, POSITION (for non looping elements)
		bgLayers = { { "INGAME_SKIES_1", "BACKGROUND_3_LAYER_1", 0.125, 2.0 },
					 { "", "BACKGROUND_3_LAYER_2", 0.5, 2.0 },
					 { "", "BACKGROUND_3_LAYER_3", 1.0, 1.6 } },
	...
	theme4 = {
		index = 4,
		music = "ambient_theme1",
		texture = "THEME_GROUND_TEXTURE_4",
		graphicSetName = "THEME_04",
		
		-- SHEET, SPRITE, PARALLAX_SPEED, SCALE, LOOPING, POSITION (for non looping elements)
		bgLayers = { { "INGAME_SKIES_1", "BACKGROUND_4_LAYER_1", 0.125, 2.0 },
					 { "", "BACKGROUND_4_LAYER_2", 0.5, 2.0 },
					 { "", "BACKGROUND_4_LAYER_3", 1.0, 1.85 } },
	...
	theme5 = {
		index = 5,
		music = "ambient_theme3",
		texture = "THEME_GROUND_TEXTURE_5",
		graphicSetName = "THEME_05",

		-- SHEET, SPRITE, PARALLAX_SPEED, SCALE, LOOPING, POSITION (for non looping elements)
		bgLayers = { { "INGAME_SKIES_1", "BACKGROUND_5_LAYER_1", 0.125, 2.0 },
					 { "", "BACKGROUND_5_LAYER_2", 0.5, 2.0 },
					 { "", "BACKGROUND_5_LAYER_3", 1.0, 1.8 } },
	...
	theme6 = {
		index = 6,
		music = "ambient_theme3",
		texture = "THEME_GROUND_TEXTURE_6",
		graphicSetName = "THEME_06",
		
		-- SHEET, SPRITE, PARALLAX_SPEED, SCALE, LOOPING, POSITION (for non looping elements)
		bgLayers = { { "INGAME_SKIES_2", "BACKGROUND_6_LAYER_1", 0.3, 4.5 },
					 { "", "BACKGROUND_6_LAYER_2", 0.55, 3.3 },
					 { "", "BACKGROUND_6_LAYER_3", 1.0, 2 } },
	...
	theme7 = {
		...
		texture = "THEME_GROUND_TEXTURE_7",
		graphicSetName = "THEME_07",
		
		-- SHEET, SPRITE, PARALLAX_SPEED, SCALE, LOOPING, POSITION (for non looping elements)
		bgLayers = { { "INGAME_SKIES_2", "BACKGROUND_7_LAYER_1", 0.125, 3.5 },		
					 { "", "BACKGROUND_7_LAYER_2", 0.5, 3 },
					 { "", "BACKGROUND_7_LAYER_3", 1.0, 2.8 } },
	...
	theme8 = {
		index = 8,
		music = "ambient_theme2",
		texture = "THEME_GROUND_TEXTURE_8",
		graphicSetName = "THEME_08",
		
		-- SHEET, SPRITE, PARALLAX_SPEED, SCALE, LOOPING, POSITION (for non looping elements)
		bgLayers = { { "INGAME_SKIES_2", "BACKGROUND_8_LAYER_1", 0.125, 2.5 },		
					 { "", "BACKGROUND_8_LAYER_2", 0.5, 2.5 },
					 { "", "BACKGROUND_8_LAYER_3", 1.0, 1.8 } },
	...
	theme16 = {
		index = 16,
		music = "ambient_theme3",
		graphicSetName = "THEME_9",
		texture = "THEME_GROUND_TEXTURE_10",
		bgLayers = {
			{
				"INGAME_SKIES_2",
	...
	theme17 = {
		...
		texture = "THEME_GROUND_TEXTURE_CAVE",
		bgLayers = {
			{
				"",
...
blocks = {
	RedBird = { --red
		...
		spriteSpecial = "BIRD_RED_FLYING",

		allowRoll = true,
		density = 6,
		damageFactors = "RedBirdDamageFactors",
		controllable = true,
		material = "red",
		strength = 60,
		group = "birds",
	...
	SmallBlueBird = { --blue(s)
		...
		spriteSpecial = "BIRD_BLUE_COLLISION",
	...
	BasicBird2 = { --matilda
		...
		density = 4.5,
		damageFactors = "BasicBird2DamageFactors",
		controllable = true,
		material = "red",
		strength = 60,
		group = "birds",
	...
	BaitSardine = {
		...
		particlesTrail = "redBirdTrail",
		collisionSound = "sardine_can_physics",
	...
	GlobeBird = { --bubbles
		...
		spriteAction = "BIRD_PUFFER",
		puffedSprite = "BIRD_PUFFER_2",
		spriteScore = "10K_ORANGE",
		spriteBlink = "BIRD_PUFFER_BLINK",

		particlesTrail = "orangeBirdTrail",
		collisionSound = "bubbles_collision",
		launchSound = "bubbles_flying",
		specialSound = "bubbles_activation_1",
		selectionSound = "bubbles_select",
		unselectionSound = "bubbles_idle_a3",
		removeSound = "bubbles_deflating",
	...
	GlobeBirdBig = { --fat bubbles
		...
		unselectionSound = "bubbles_idle_a3",
		removeSound = "bubbles_deflating",
		idleSound = "bubbles_idle",
		slingshotSound = "bubbles_idle",
	}, 
	PinkBird = { --stella
		radius = 0.85,
		friction = 0.3,
		...
		sprite = "BIRD_PINK",
		spriteFlying = "BIRD_PINK_RELEASE",
		spriteCollision = "BIRD_PINK_RELEASE",
		spriteAction = "HUD_ICON_BUBBLES",
		spriteScore = "10K_RED",
		spriteYell = "BIRD_PINK_YELL",
		...
		particlesAmountLimits = {12, 20},
		particlesTrail = "pinkBirdTrail",
		collisionSound = "bird_pink_collision",
		launchSound = "pink_launch_01",
		specialSound = "pink_special_02",
		selectionSound = "pink_activate_01",
		unselectionSound = "bird_01_unselect",
		specialty = "BUBBLES",
		specialtyRadius = 7,
		tutorialInfo = "TUTORIAL_1",
	...
	StaticBlockTheme16_01 = {
		type = "box",
		sprite = "GROUND_BLOCK_01",
		texture = "THEME_GROUND_TEXTURE_9",
		theme = "theme16",
		material = "immovable",
		group = "staticBlocks",
		groupIndex = 1
	...
	StaticFragileBlock06 = {
		type = "box",
		sprite = "GROUND_BLOCK_06_FRAGILE",
		material = "grey_block",
		group = "staticFragile",
		groupIndex = 6,
		destroyedScoreInc = 50
