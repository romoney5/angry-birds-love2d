--aes reimplementation in lua: https://gist.github.com/perara/77b82012bdd2a702c98a714b57e1fb85
...
--
--romoney5: AES_x instead of x
function AES_encrypt(password, data, keyLength, mode, iv)
...
--
--romoney5: AES_x instead of x
function AES_decrypt(password, data, keyLength, mode, iv)
	local mode = mode or CBCMODE
	local keyLength = keyLength or AES128
